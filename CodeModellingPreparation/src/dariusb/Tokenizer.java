...
import dariusb.languages.LanguageKeywords;

/**
 * This class will take a {@link String} input and tokenize it based on the language (an object that
 * extends the {@link dariusb.languages.LanguageKeywords}). There are two forms of output for the tokenized input.
 * <p>
...
public class Tokenizer {
	 ...
	 */
	public Tokenizer(JavaKeywords language ) {
		_language = language;
	 ...
	 *         (excluding spacing), from the input. If no {@link dariusb.languages.LanguageKeywords} is set a
